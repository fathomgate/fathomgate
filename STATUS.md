...
Tasks: open 14 · blocked 9 · in review 5 · merged 6 · dropped 3
...
| M1-35 | Refuse tool arguments the profile does not name (eos-mcp config_path) (ADR) | `internal/classify` | policy-engineer | security-reviewer, go-reviewer | open | — | 4 | — |
...
| M1-37 | Make an unset unknown_target deny every class (ADR) | `internal/policy` | policy-engineer | security-reviewer, go-reviewer | open | — | 6 | — |
