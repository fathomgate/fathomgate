...
Tasks: open 1 · blocked 3 · in progress 1 · in review 3 · merged 4
...
| T0.6 | Verify GoReleaser snapshot and distroless image build with the new toolchain | `.goreleaser.yaml` | release-engineer | go-reviewer | in review | T0.1 | — | — |
