...
Tasks: open 8 · merged 46 · validated 2 · dropped 1
...
| T0.46 | Kill the upstream's whole process tree so a launcher's grandchild cannot outlive a restart or shutdown (S2) | `internal/proxy` | mcp-protocol-engineer | security-reviewer, go-reviewer | merged | — | 2, 22 | — |
...
| T0.52 | Apply the post-merge security review of PR | `cmd/fathomgate` | mcp-protocol-engineer | security-reviewer, go-reviewer | merged | — | 23 | [0016](docs/adr/0016-streamable-http-listener.md) |
