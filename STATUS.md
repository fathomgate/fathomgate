...
Tasks: open 3 · blocked 1 · merged 34 · dropped 5
...
| M1-07 | Record the PR #108 review's upstream-content findings in the threat model and route them to M1 and M2 | `docs/security` | security-reviewer | docs-writer | merged | — | 15, 16 | — |
| M1-08 | Write the product name as Fathomgate in prose across docs (ADR 0019 voice rule) | `docs` | docs-writer | design-guardian | merged | — | — | — |
...
| M1-15 | Tier 1 fallback-classification tests for every other surveyed tool in brief 02 | `internal/classify` | test-engineer | policy-engineer, security-reviewer, go-reviewer | merged | — | — | — |
...
| M1-17 | Meta-tool classification through capability tables (Meraki execute_api) | `internal/classify` | policy-engineer | security-reviewer, go-reviewer, upstream-server-scout | merged | — | 18 | [0010](docs/adr/0010-classify-by-payload-not-annotations.md) |
