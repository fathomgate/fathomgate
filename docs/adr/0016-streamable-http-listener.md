...
| 2026-09-24 | The export surface gains one error value, `proxy.ErrMCPGODEBUG`. `cmd/netguard` returns that value from its own pre-flight check instead of a second copy of the same sentence | T0.40, K4 in the re-review of PR #72: one refusal text in one place |
