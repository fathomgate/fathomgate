...
| [0022](0022-internal-proxy-export-surface.md) | The exported surface of `internal/proxy`, restated in one record | proposed | 2026-09-25 |
| [0023](0023-listener-binds-both-loopback-families.md) | `serve --listen` binds both loopback families, and three smaller listener changes | proposed | 2026-09-25 |
