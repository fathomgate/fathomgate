...
- Its serving, authentication, identity namespace and frontend stack are decided in the local console ADR ([ADR 0024](0024-local-console-embedded-loopback-only.md), proposed).
...
- The local console ADR ([ADR 0024](0024-local-console-embedded-loopback-only.md), proposed)
