...
| M5 More vendors + watchdog | IOS-XE, NX-OS, PAN-OS, FortiOS drivers with proxy-owned rollback watchdog; optional OPA backend. The approval console and audit viewer (R29) moved to the commercial edition ([ADR 0020, amendment of 2026-09-25](adr/0020-open-core-apache-2.md#amendments)) | Watchdog rolls back an unconfirmed NX-OS change on a containerlab device | Palo-MCP, mcfortigate, netdev-ssh-mcp on IOS-XE and NX-OS | 5 weeks |
...
fathomgate/
  ...
  design/                  tokens.css, policy.css, DESIGN.md, preview.html (the commercial console builds on these; it is not in this repo)
