Run an adversarial security review of the diff on the current branch against main, working the Fathomgate attack catalogue and citing OWASP MCP Top 10 items. Usage: `/security-review` (optionally `/security-review <base-branch>`)
